        ...
        for key, trade in list(app_state.open_trades.items()):
            try:
                ...
                if (_elapsed >= 90
                    ...
                    print(f"[ADVERSE_CUT] MEXC {sym} {direction}"
                ...
                if (_elapsed >= 600
                    ...
                    print(f"[DEAD_TRADE_KILL] MEXC {sym} {direction}"
                          f" elapsed={_elapsed:.0f}s"
                ...
                if (not _sh.get("be_armed", False)
                    ...
                    print(f"[TREND_ADVERSE_EXIT] MEXC {sym} {direction}"
                          f" age={{_elapsed:.0f}}s"
                          f" mfe={{_mfe_pnl:.2f}} dr={{_dr:.2f}}"
                ...
                if (_sh.get("be_armed")
                    ...
                    _pg_r = _cpnl / _dr_ac
                    print(f"[PEAK_GIVEBACK] MEXC {sym} {direction}"
